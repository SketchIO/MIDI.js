...
const debug = Debug('MIDI.js:src/audioTest.js')
...
export function register(format, codec, base64) {
...
export default function () {
	debug('Testing audio technologies and formats: %j', {
		technologies: [
			'audio-tag',
			'WebAudio API',
			'WebMIDI API'
		],
		formats: Object.keys(tests)
	})
	detectAudio();
	detectMIDI();
	detectWebAudio();
